...
void GalaxySeeder::Seed()
{
    ...
    std::uniform_real_distribution<double> dist(-320.0f, 320.0);
    std::uniform_real_distribution<double> dist_vel(0.0f, 3.0f);
    std::uniform_real_distribution<double> dist_mass(1e28, 1e30);
    ...
    Particles[0].Mass = 1e35;
    Particles[0].Position = { -300, 0, 0 };

    Particles[Particles.size() / 2].Mass = 1e35;
