...
void scatter(float3 pos) {
	...
	v3FrontColor.x = clamp(v3FrontColor.x, 0.0, 3000000000000.0);
	v3FrontColor.y = clamp(v3FrontColor.y, 0.0, 3000000000000.0);
	v3FrontColor.z = clamp(v3FrontColor.z, 0.0, 3000000000000.0);
